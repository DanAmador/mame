...
static ADDRESS_MAP_START( main_map, AS_PROGRAM, 16, xexex_state )
	...
	AM_RANGE(0x0c6000, 0x0c7fff) AM_DEVREADWRITE("lvc", k053250_device, ram_r, ram_w)    // K053250 "road" RAM
//	AM_RANGE(0x0c8000, 0x0c800f) AM_DEVICE8("k053250", k053250_device, map, 0x00ff)
	AM_RANGE(0x0c8000, 0x0c800f) AM_DEVREADWRITE("lvc", k053250_device, reg_r, reg_w)
...
//	MCFG_K053250_ADD("lvc")
	MCFG_K053250_ADD("lvc", "palette", "screen", -5, -16)
